      ...
      <div style={{ minHeight: "100vh", background: bg, color: textColor, transition: "background 0.3s, color 0.3s" }}>
        ...
        <div style={{ maxWidth: "1200px", margin: "0 auto", padding: "16px" }}>
          ...
          {profile.membership_tier === "free" && (
            <div id="upgrade" style={{ marginTop: "32px", background: "#FFFFFF", border: "1px solid rgba(201,168,76,0.3)", borderRadius: "16px", padding: "40px", boxShadow: "0 2px 12px rgba(201,168,76,0.08)" }}>
              <div style={{ textAlign: "center", marginBottom: "32px" }}>
                ...
                <p style={{ color: "#5C4F3A", fontSize: "15px", margin: "0 auto", lineHeight: "1.7", maxWidth: "500px" }}>Reading is always free. Ink Monthly lets you unlock stories without watching ads — and directly supports the writers you love.</p>
              </div>
              <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(200px, 1fr))", gap: "16px" }}>
                <div style={{ background: "#FAF7F2", border: "1px solid rgba(201,168,76,0.15)", borderRadius: "12px", padding: "24px" }}>
                  ...
                  <p style={{ color: "#1A1612", fontSize: "28px", fontWeight: "700", margin: "0 0 4px" }}>Free</p>
                  ...
                  {["Full Reading Room access", "Earn Ink by watching ads", "Tip your favorite writers", "Red Room access (18+ verified)"].map((perk, i) => (
                    <p key={i} style={{ color: "#5C4F3A", fontSize: "12px", margin: "0 0 4px" }}>✦ {perk}</p>
                  ))}
                ...
                <div style={{ background: "rgba(100,149,237,0.05)", border: "1px solid rgba(100,149,237,0.2)", borderRadius: "12px", padding: "24px" }}>
                  ...
                  <p style={{ color: "#1A1612", fontSize: "28px", fontWeight: "700", margin: "0 0 4px" }}>$3<span style={{ fontSize: "14px", color: "#555" }}>/mo</span></p>
                ...
                <div style={{ background: "rgba(201,168,76,0.06)", border: "2px solid rgba(201,168,76,0.4)", borderRadius: "12px", padding: "24px", position: "relative" }}>
                  ...
                  <p style={{ color: "#1A1612", fontSize: "28px", fontWeight: "700", margin: "0 0 4px" }}>$5<span style={{ fontSize: "14px", color: "#555" }}>/mo</span></p>
                ...
                <div style={{ background: "rgba(255,255,255,0.03)", border: "1px solid rgba(255,255,255,0.1)", borderRadius: "12px", padding: "24px" }}>
                  ...
                  <p style={{ color: "#1A1612", fontSize: "28px", fontWeight: "700", margin: "0 0 4px" }}>$9<span style={{ fontSize: "14px", color: "#555" }}>/mo</span></p>
