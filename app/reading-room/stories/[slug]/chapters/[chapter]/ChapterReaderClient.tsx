...
// =========================
export default function ChapterReaderClient({ storySlug, chapterNum }: { storySlug: string; chapterNum: number }) {
  return <ChapterReaderContent storySlug={storySlug} chapterNum={chapterNum} />;
}
